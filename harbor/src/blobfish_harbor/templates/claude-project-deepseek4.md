...
Within the first 10 tool calls, write a solution file with your best evidence-backed draft to the required output path; iterate from a committed deliverable, not from exploration. You can overwrite it later if stronger evidence appears.
